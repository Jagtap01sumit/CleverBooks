    ...
    <div className="md:h-[50rem] h-[60rem] bg-white w-full">
      <div className="md:h-[50rem] h-[60rem] w-full bg-hero">
        ...
        <div className=" flex md:flex-row flex-col md:pt-24 pt-10 text-white w-full">
          <div className="relative flex flex-col md:w-1/2 lg:pl-32 py-10 px-5  md:top-16 w-full">
            <h1 className="my-3 text-[40px] md:text-[50px] lg:text-[70px] font-semibold md:tracking-wide">
          ...
          <div className=" relative flex lg:items-end justify-end right-0 md:w-1/2 lg:top-[40px] px-5">
